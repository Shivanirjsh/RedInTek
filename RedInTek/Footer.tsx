        ...
        <section id="footer">
            ...
            <footer>
                <div>
                    ...
                    <h3 style={{fontWeight:'bold',letterSpacing:'0.1rem',lineHeight:'1.1',marginTop:'20px'}}>Gmate</h3>
                </div>
                <h3 style={{color:'#b2d1f5',marginTop:'5px',fontSize:'1rem'}}>The Cosmos Data & Development Platform</h3>
            </footer>
        </section> 
    )
}
